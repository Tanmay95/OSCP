...
┌──(offsec㉿kali)-[~/Downloads/OSCP/labs/Resourced]                                                                                                                                                                                                                                                                                                                                                                                  
└─$ nmap -p 88 --script=krb5-enum-users --script-args krb5-enum-users.realm=vault.offsec,userdb=user.txt 192.168.237.172 -Pn                                                                                    
```
